/* ============================================================
   ...
   Use: <div id="sidebar" data-active="dashboard"></div>
   ============================================================ */
(function () {
  'use strict';
  ...
  const CATS = [
    { nome: 'Estudos', cor: 'var(--color-cat-estudos)', n: 5 },
    { nome: 'Casa', cor: 'var(--color-cat-casa)', n: 4 },
    { nome: 'Genérico', cor: 'var(--color-cat-generico)', n: 5 },
  ];
  ...
  function render(mount) {
    ...
    catToggle.addEventListener('click', () => {
      const oculto = catNav.classList.toggle('hidden');

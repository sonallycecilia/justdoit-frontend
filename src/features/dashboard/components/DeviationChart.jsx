// Barras agrupadas: tempo planejado vs. executado por dia da semana.
// SVG puro, sem dependências (port de components/Dashboard/DeviationChart.jsx).
export default function DeviationChart({ dados }) {
  ...
  const pico = Math.max(...dados.flatMap((d) => [d.plan, d.real]), 0);

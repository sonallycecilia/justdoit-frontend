...
import { fmtHora } from '../../hooks/useTimeBlocks';
...
export default function TimeBlock({ ev, rowH, startHour, catCor, onDragStart, onDragEnd, dragging, onOpen, onDrawer, onDelete, layout }) {
